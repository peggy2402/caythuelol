...
const dictionaries = {
  vi: {
    ...
    noTransfer: 'Chưa có giao dịch nào',
    ...
    boosterApplySubtitle: "BECOME A LEGEND",
    boosterApplyDesc: "Gia nhập hệ thống cày thuê uy tín số 1. Thu nhập hấp dẫn, thanh toán minh bạch, bảo vệ quyền lợi tuyệt đối.",
    step1Info: "Thông tin cá nhân",
    step2Game: "Hồ sơ Game & Cọc",
    step3Commit: "Cam kết & Ký tên",
    fullName: "Họ và tên thật",
    facebookUrl: "Link Facebook chính chủ",
    discordTag: "Discord Tag",
    rankProof: "Link ảnh bằng chứng",
    depositInfoTitle: "Thông tin cọc: 200.000 VNĐ",
    depositInfoDesc: "Hoàn lại 100% khi nghỉ làm.",
    bankName: "Ngân hàng",
    bankAccountNum: "Số tài khoản",
    bankAccountName: "Chủ tài khoản",
    digitalSignature: "Xác nhận chữ ký số",
    signatureDesc: "Nhập họ tên ({name}) để xác nhận.",
    submitApp: "Gửi Đăng Ký",
    confirmAppTitle: "Xác nhận đăng ký",
    confirmAppDesc: "Bạn cam kết mọi thông tin là sự thật và chấp nhận các quy định của hệ thống.",
    confirmSend: "Xác nhận & Gửi",
    phoneNumber: 'Số điện thoại',
    opggLink: 'Link OP.GG',
    highestRank: 'Rank cao nhất đạt được',
    nextStep: 'Bước tiếp theo',
    prevStep: 'Bước trước',

    // Commitments
    commitTool: "Không Tool/Hack",
    commitToolDesc: "Tuyệt đối không sử dụng phần mềm thứ 3 can thiệp vào game.",
    commitSecurity: "Bảo mật tài khoản",
    commitSecurityDesc: "Không thay đổi thông tin (Email, Pass) của khách hàng.",
    commitPrivate: "Riêng tư",
    commitPrivateDesc: "Không liên hệ riêng, không giao dịch ngoài hệ thống.",
    commitStream: "Quy định Stream",
    commitStreamDesc: "Chỉ Stream khi khách hàng cho phép.",
    commitPenalty: "Chế tài xử phạt",
    commitPenaltyDesc: "3 tố cáo hợp lệ/tháng sẽ bị khóa tài khoản vĩnh viễn.",
    commitDeposit: "Quy định cọc",
    commitDepositDesc: "Tiền cọc sẽ bị mất nếu vi phạm quy định nghiêm trọng.",
  },
  ...
  en: {
    ...
    boosterApplySubtitle: "BECOME A LEGEND",
    boosterApplyDesc: "Join the #1 trusted boosting system. Attractive income, transparent payment, absolute rights protection.",
    step1Info: "Personal Info",
    step2Game: "Game Profile & Deposit",
    step3Commit: "Commitment & Signature",
    fullName: "Full Name",
    facebookUrl: "Facebook Profile URL",
    discordTag: "Discord Tag",
    rankProof: "Rank Proof Image",
    depositInfoTitle: "Deposit Info: 200,000 VND",
    depositInfoDesc: "100% refundable upon resignation.",
    bankName: "Bank Name",
    bankAccountNum: "Account Number",
    bankAccountName: "Account Holder",
    digitalSignature: "Digital Signature",
    signatureDesc: "Enter full name ({name}) to confirm.",
    submitApp: "Submit Application",
    confirmAppTitle: "Confirm Application",
    confirmAppDesc: "You commit that all information is true and accept the system regulations.",
    ...
    // Commitments
    commitTool: "No Tool/Hack",
    commitToolDesc: "Absolutely no use of 3rd party software interfering with the game.",
    commitSecurity: "Account Security",
    commitSecurityDesc: "Do not change customer information (Email, Pass).",
    commitPrivate: "Privacy",
    commitPrivateDesc: "No private contact, no transactions outside the system.",
    commitStream: "Stream Rules",
    commitStreamDesc: "Only Stream when allowed by the customer.",
    commitPenalty: "Penalty Policy",
    commitPenaltyDesc: "3 valid reports/month will result in permanent account lock.",
    commitDeposit: "Deposit Rules",
    commitDepositDesc: "Deposit will be lost if serious regulations are violated.",
  },
  ...
  kr: {
    ...
    boosterApplySubtitle: "전설이 되세요",
    boosterApplyDesc: "신뢰할 수 있는 1위 부스팅 시스템에 가입하세요. 매력적인 수입, 투명한 결제, 절대적인 권리 보호.",
    step1Info: "개인 정보",
    step2Game: "게임 프로필 & 보증금",
    step3Commit: "서약 & 서명",
    fullName: "성명",
    facebookUrl: "Facebook 프로필 URL",
    discordTag: "Discord 태그",
    rankProof: "랭크 증명 이미지",
    depositInfoTitle: "보증금 정보: 200,000 VND",
    depositInfoDesc: "사임 시 100% 환불 가능.",
    bankName: "은행명",
    bankAccountNum: "계좌 번호",
    bankAccountName: "예금주",
    digitalSignature: "디지털 서명",
    signatureDesc: "확인을 위해 성명({name})을 입력하세요.",
    submitApp: "신청서 제출",
    confirmAppTitle: "신청 확인",
    confirmAppDesc: "모든 정보가 사실임을 서약하고 시스템 규정을 수락합니다.",
    confirmSend: "확인 및 전송",
    phoneNumber: '전화번호',
    opggLink: 'OP.GG 링크',
    highestRank: '최고 랭크 달성',
    nextStep: '다음 단계',
    prevStep: '이전 단계',

    // Commitments
    commitTool: "툴/핵 사용 금지",
    commitToolDesc: "게임에 개입하는 제3자 소프트웨어 사용 절대 금지.",
    commitSecurity: "계정 보안",
    commitSecurityDesc: "고객 정보(이메일, 비밀번호)를 변경하지 마십시오.",
    commitPrivate: "개인 정보 보호",
    commitPrivateDesc: "개인적인 연락 금지, 시스템 외부 거래 금지.",
    commitStream: "방송 규정",
    commitStreamDesc: "고객이 허용한 경우에만 방송하십시오.",
    commitPenalty: "처벌 정책",
    commitPenaltyDesc: "월 3회 유효한 신고 접수 시 계정이 영구 정지됩니다.",
    commitDeposit: "보증금 규정",
    commitDepositDesc: "중대한 규정 위반 시 보증금은 몰수됩니다.",
  },
  ...
  jp: {
    ...
    boosterApplyDesc: "信頼できるNo.1ブースティングシステムに参加しましょう。魅力的な収入、透明な支払い、絶対的な権利保護。",
    step1Info: "個人情報",
    step2Game: "ゲームプロフィール & デポジット",
    step3Commit: "誓約 & 署名",
    fullName: "氏名",
    facebookUrl: "FacebookプロフィールURL",
    discordTag: "Discordタグ",
    rankProof: "ランク証明画像",
    depositInfoTitle: "デポジット情報: 200,000 VND",
    depositInfoDesc: "辞任時に100%返金可能。",
    bankName: "銀行名",
    bankAccountNum: "口座番号",
    bankAccountName: "口座名義人",
    digitalSignature: "デジタル署名",
    signatureDesc: "確認のために氏名（{name}）を入力してください。",
    submitApp: "申請を提出",
    confirmAppTitle: "申請の確認",
    confirmAppDesc: "すべての情報が真実であることを誓約し、システム規定に同意します。",
    confirmSend: "確認して送信",
    phoneNumber: '電話番号',
    opggLink: 'OP.GGリンク',
    highestRank: '最高ランク達成',
    ...
    commitSecurity: "アカウントセキュリティ",
    commitSecurityDesc: "顧客情報（メール、パスワード）を変更しないでください。",
    commitPrivate: "プライバシー",
    commitPrivateDesc: "個人的な連絡禁止、システム外での取引禁止。",
    commitStream: "配信規定",
    commitStreamDesc: "顧客が許可した場合のみ配信してください。",
    commitPenalty: "処罰ポリシー",
    commitPenaltyDesc: "月に3回の有効な報告があった場合、アカウントは永久にロックされます。",
