...
export default function TFTServicePage() {
  return (
      ...
      <main className="relative pt-32 pb-20 container mx-auto px-6">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6">
            DỊCH VỤ <span className="text-orange-500">TFT</span>
          </h1>
          
          <p className="text-zinc-400 text-lg max-w-xl mx-auto mb-10">
            Hệ thống đang trong quá trình hoàn thiện tính năng Đấu Trường Chân Lý. 
