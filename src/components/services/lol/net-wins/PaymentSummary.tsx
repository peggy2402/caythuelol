...
import { Flame, ArrowRight, CheckCircle2, ShieldAlert, ChevronUp, ChevronDown } from 'lucide-react';
...
export default function PaymentSummary({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 lg:sticky lg:top-24 rounded-t-2xl lg:rounded-2xl border-t lg:border border-white/10 bg-zinc-900/95 lg:bg-zinc-900/80 backdrop-blur-xl p-4 lg:p-6 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] lg:shadow-2xl transition-all">
        ...
        {boosterId && (
            <div className="hidden lg:flex justify-between items-end pt-4 border-t-2 border-white/10 mt-2 mb-6">
